...
class LsPage(am):
    ...
    def merchantInfo(self):
        ...
        #经营类目
        self.click(by.XPATH,'/html/body/div[1]/form[3]/div[4]/div/div[2]/div[1]/div/div/dl[1]/dd[2]')
        ...
        self.click(by.XPATH,'/html/body/div[5]/div/div[1]/select[1]')
    ...
    def bankInfo(self):
        ...
        self.sleep_time(1)
        self.click(by.ID,'/html/body/div[1]/form[3]/div[4]/div/div[18]/div/div[2]/div/dl/dd')
        self.input(by.ID,self.data['开户支行名称'])
        # self.click(by.ID,'/html/body/div[1]/form[3]/div[4]/div/div[18]/div/div[4]/div/ul/li')
