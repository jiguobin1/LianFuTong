...
class LsPage(am):
    ...
    def merchantInfo(self):
        ...
        #商户所属地区  门店有问题
        if self.data['门店id']!='':
            self.click(by.XPATH,'/html/body/div[1]/form/div[4]/div[1]/div[9]/div[1]/div[1]/div/a/label')
            self.click(by.LINK_TEXT,self.data['商户省'])
            self.click(by.XPATH,'/html/body/div[1]/form/div[4]/div[1]/div[9]/div[1]/div[2]/div/a/label')
            self.click(by.LINK_TEXT,self.data['商户市'])
            self.click(by.XPATH,'/html/body/div[1]/form/div[4]/div[1]/div[9]/div[1]/div[3]/div/a/label')
            self.click(by.LINK_TEXT,self.data['商户区'])
        else:
            self.click(by.XPATH,'/html/body/div[1]/form[3]/div[4]/div/div[9]/div[1]/div[1]/div/a/label')
            self.click(by.LINK_TEXT,self.data['商户省'])
            self.click(by.XPATH,'/html/body/div[1]/form[3]/div[4]/div/div[9]/div[1]/div[2]/div/a/label')
            self.click(by.LINK_TEXT,self.data['商户市'])
            self.click(by.XPATH,'/html/body/div[1]/form[3]/div[4]/div/div[9]/div[1]/div[3]/div/a/label')
            self.click(by.LINK_TEXT,self.data['商户区'])
        ...
        self.sleep_time(0.5)
        self.click(by.XPATH,'/html/body/div[5]/div/div[2]/table/tbody[2]/tr[1]/td[7]')
    ...
    def bankInfo(self):
        if self.sheet[2:]=='个人':
            ...
            if self.sheet[2:]=='个人' and self.data['结算人类型']=='非法人':
                self.click(by.LINK_TEXT,self.data['结算人类型'])
                self.input(by.ID,'legalFlagCardNo',self.data['非法人结算身份证号码'])
            #北京省北京市同一个值 text定位不到
        if self.data['开户省']=='北京':
            if self.data['门店id']!='':
                self.click(by.XPATH,'/html/body/div[1]/form/div[4]/div[1]/div[19]/div/div[1]/div/div[1]/div/a/label')
                self.click(by.XPATH,'/html/body/div[1]/form/div[4]/div[1]/div[19]/div/div[1]/div/div[1]/div/dl/dd[2]/a')
                self.click(by.XPATH,'/html/body/div[1]/form/div[4]/div[1]/div[19]/div/div[1]/div/div[2]/div/a/label')
                self.click(by.XPATH,'/html/body/div[1]/form/div[4]/div[1]/div[19]/div/div[1]/div/div[2]/div/dl/dd[2]/a')
            else:
                self.click(by.XPATH,'/html/body/div[1]/form[3]/div[4]/div/div[19]/div/div[1]/div/div[1]/div/a/label')
                self.click(by.XPATH,'/html/body/div[1]/form[3]/div[4]/div/div[19]/div/div[1]/div/div[1]/div/dl/dd[2]/a')
                self.click(by.XPATH,'/html/body/div[1]/form[3]/div[4]/div/div[19]/div/div[1]/div/div[2]/div/a/label')
                self.click(by.XPATH,'/html/body/div[1]/form[3]/div[4]/div/div[19]/div/div[1]/div/div[2]/div/dl/dd[2]/a')
        else:
            if self.data['门店id']!='':
                self.click(by.XPATH,'/html/body/div[1]/form/div[4]/div[1]/div[19]/div/div[1]/div/div[1]/div/a/label')
        ...
        if self.data['门店id']!='':
            self.click(by.XPATH,'/html/body/div/form/div[4]/div[1]/div[19]/div/div[2]/div[1]/dl/dd')
        else:
            self.click(by.XPATH,'/html/body/div/form[3]/div[4]/div[1]/div[19]/div/div[2]/div[1]/dl/dd')
        ...
        self.sleep_time(1)
        if self.data['门店id']!='':
           self.click(by.XPATH,'/html/body/div/form/div[4]/div[1]/div[19]/div/div[4]/div/ul/li')
        else:
            self.click(by.XPATH,'/html/body/div[1]/form[3]/div[4]/div/div[19]/div/div[4]/div/ul/li')
        if self.sheet[2:]=='企业':
    ...
    def imageInfo(self):
        ...
        if self.sheet[2:]=='个人' and self.data['结算人类型']=='非法人':
            self.input(by.ID,'file8',self.data['非法人结算授权图片'])
